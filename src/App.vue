      ...
      >
        ...
        >
          ...
          >
            <g>
              <path
                  d="M436.896,74.869c-99.84-99.819-262.208-99.819-362.048,0c-99.797,99.819-99.797,262.229,0,362.048    c49.92,49.899,115.477,74.837,181.035,74.837s131.093-24.939,181.013-74.837C536.715,337.099,536.715,174.688,436.896,74.869z
                  ...
                  fill="#718096" data-original="#000000"
              />
            </g>
          </svg>
        </button>
...
export default {
  ...
  methods: {
    ...
    showToast() {
      this.toasts = this.coins.filter(t => t.toUpperCase().indexOf(this.ticker.toUpperCase()) === 0).slice(0, 4)
    },
